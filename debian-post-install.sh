...
#native packages
sudo apt-get install android-tools-adb android-tools-fastboot krita telegram-desktop discord steam obs-studio code vlc lutris streamlink python3 git gnome-tweaks ubuntu-restricted-extras neofetch barrier refind -y;
